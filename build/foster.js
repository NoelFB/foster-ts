...
})(exports.ResolutionStyle || (exports.ResolutionStyle = {}));
class BlendMode {
...
class Graphics {
     ...
     */
    constructor(engine) {
        this.resolutionStyle = exports.ResolutionStyle.Contain;
...
class IO {
     ...
     */
    static init() {
        if (IO.fs == null && Engine.client === exports.Client.Electron) {
            IO.fs = require("fs");
